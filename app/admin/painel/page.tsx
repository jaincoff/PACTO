    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 overflow-y-auto pt-16 lg:pt-0">
        <div className="mx-auto max-w-6xl space-y-8 p-4 lg:p-8">
          ...
          <section id="pending-supervisors">
            <div className="mb-4">
              <h2 className="text-xl font-semibold text-foreground">
                Supervisores Pendentes de Aprovacao
              </h2>
              <p className="text-sm text-muted-foreground">
                Reveja os testes e aprove os supervisores.
              </p>
            </div>
            ...
            {pendingSupervisors.length === 0 ? (
              <Card className="border-border bg-card">
                <CardContent className="flex flex-col items-center gap-3 p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Todos os supervisores foram revistos.
                  </p>
                </CardContent>
              </Card>
            ) : (
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleExpandSupervisor(supervisor)
                              }
                            >
                              {isExpanded ? (
                                <>
                            ...
                            <Button
                              ...
                              className="gap-1.5 rounded-lg"
                              onClick={() =>
                                handleApproveUser(supervisor.id)
                              }
                              disabled={approving === supervisor.id}
                            >
                              <CheckCircle className="h-4 w-4" />
                              {approving === supervisor.id
                                ? "A aprovar..."
                                : "Aprovar"}
                            </Button>
                          </div>
          ...
          <section className="space-y-4">
            ...
            <Card className="border-border bg-card shadow-sm">
              <CardContent className="flex flex-col items-center gap-3 p-8 text-center">
                ...
                <p className="font-medium text-foreground">
                  Registo de auditoria em breve
                </p>
                <p className="text-sm text-muted-foreground">
                  As acoes dos administradores e supervisores serao registadas
                  automaticamente.
                </p>
              </CardContent>
            </Card>
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  id: "papeis",
                  title: "Gestao de Papeis",
                  desc: "Funcoes e permissoes.",
                  icon: UserCog,
                },
                {
                  id: "permissoes",
                  title: "Permissoes",
                  desc: "Niveis de acesso.",
                  icon: Lock,
                },
                {
                  id: "avaliacoes",
                  title: "Avaliacoes",
                  desc: "Questionarios e avaliacoes.",
                  icon: Clipboard,
                },
                {
                  id: "rgpd",
                  title: "Seguranca e RGPD",
                  desc: "Privacidade e protecao de dados.",
                  icon: Shield,
                },
              ].map((config) => {
          ...
          <section className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Exportacao de dados para investigacao cientifica.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                { id: "anonimizados", title: "Dados Anonimizados", label: "Exportar" },
                { id: "cientifico", title: "Relatorio Cientifico", label: "Gerar" },
                { id: "longitudinal", title: "Exportacao Longitudinal", label: "Exportar" },
              ].map((option) => (
                <Card
                  key={option.id}
                  className="border-border bg-card shadow-sm"
